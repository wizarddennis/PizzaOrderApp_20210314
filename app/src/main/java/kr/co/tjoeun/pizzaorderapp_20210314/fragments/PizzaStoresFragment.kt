...
import kr.co.tjoeun.pizzaorderapp_20210314.ViewStoreDetailActivity
import kr.co.tjoeun.pizzaorderapp_20210314.adapters.StoreAdapter
import kr.co.tjoeun.pizzaorderapp_20210314.datas.Store
...
class PizzaStoresFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        mPizzaStores.add(Store("파파존선", "1588-1234", "http://mblogthumb2.phinf.naver.net/20160530_65/ppanppane_1464617766007O9b5u_PNG/%C6%C4%C6%C4%C1%B8%BD%BA_%C7%C7%C0%DA_%B7%CE%B0%ED_%284%29.png?type=w800"))
        ...
        mPizzaStores.add(Store("도미노피자", "1588-3082", "https://pbs.twimg.com/profile_images/1098371010548555776/trCrCTDN_400x400.png"))
